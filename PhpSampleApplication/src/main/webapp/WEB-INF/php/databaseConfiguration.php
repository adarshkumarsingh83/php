...
$bd = mysql_connect($mysql_hostname, $mysql_user, $mysql_password) or die("Unable to connect to MySql");
mysql_select_db($mysql_database, $bd) or die("Unable to connect to database".$mysql_database);
